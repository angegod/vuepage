    ...
    <div class="Card [&>div]:w-4/5 [&>div]:mx-auto max-[500px]:[&>div]:w-5/6 pt-3" >
        ...
        <div v-if="!isInput">
            <div class="flex flex-col flex-wrap w-[100%] mt-5">
                ...
                <div class="[&>button]:btn [&>button]:mr-2 [&>button]:w-[10%] max-sm:[&>button]:w-[20%] [&>button]:min-w-[100px]
                        max-[500px]:[&>button]:small max-[500px]:[&>button]:min-w-[100px]">
                    <button class="series break-keep" v-on:click="clicked('series_1')">晨曦塔</button>
                </div>
            </div>
            <div class="flex flex-col flex-wrap w-[100%] mt-5">
                ...
                <div class="flex flex-row">
                    <button class="max-w-[70px] mr-2 relative inline-block rarity" v-for="i in 3" v-on:click="clicked(`rarity_${i}`)" :key="`rarity${i}`">
            ...
            <div class="flex flex-col flex-wrap w-[100%] mt-5 relative">
                ...
                <div v-for="t in funcData" class="mt-5">
                    ...
                    <div class="[&>button]:btn [&>button]:mr-2 [&>button]:w-[20%] max-[500px]:[&>button]:w-[40%] [&>button]:min-w-[200px]
                            max-[500px]:[&>button]:small max-[500px]:[&>button]:min-w-[140px]">
                        <button  v-for="func in t.data" class="func mb-2 min-w-[160px] min-h-[30px]" v-on:click="clicked(`func_${func.id}`)" :id="'btn'+func.id">{{func.name }}</button>
                    </div> 
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col flex-wrap mt-5" id="searchCard" v-show="isSearch">
            ...
            <div class="flex flex-row max-[500px]:flex-col 
                ...
                <button class="mr-2 sort px-2 my-2 flex flex-row justify-center items-center btn" @click="clicked('sort_1')">
                ...
                <button class="mr-2 sort px-2 my-2 flex flex-row justify-center items-center btn" @click="clicked('sort_2')">
