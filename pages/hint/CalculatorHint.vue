             ...
             <div class="max-[500px]:w-[100%] mt-2 p-2 rounded-md bg-black" v-if="data !==null ">
                <div>
                    ...
                    <ul class="[&>li]:font-bold [&>li]:my-1 slide pl-5" id="info1">
                        ...
                        <li class="text-gray-600">練滿2星[晨曦塔]&#215;{{ data[1].goal }}</li>
                        <li class="text-yellow-500">練滿3星[晨曦塔]&#215;{{ data[2].goal }}</li>
                    </ul>
                </div>
                <div class="my-2">
                    <div class="flex">
                    ...
                    <ul class="[&>li]:font-bold [&>li]:my-1 [&>li]:text-md slide pl-5" id="info2">
                        ...
                        <li class="text-gray-600">2星[晨曦塔]&#215;{{ data[1].open }}</li>
                        <li class="text-yellow-500">3星[晨曦塔]&#215;{{ data[2].open }}</li>
                    </ul>
                </div>  
            </div>
        </template>
